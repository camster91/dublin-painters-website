    ...
    <section className="py-24 bg-slate-50 dark:bg-slate-950 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-8 relative">
          {/* Connector line */}
          <div className="hidden md:block absolute top-[45px] left-[10%] right-[10%] h-[3px] bg-slate-200 dark:bg-slate-800 z-0" />
          ...
          {steps.map((step, idx) => (
            ...
            >
              <div className="w-24 h-24 bg-white dark:bg-slate-900 border-4 border-brand-blue rounded-full flex justify-center items-center shadow-xl shadow-brand-blue/20 mb-6 font-black text-3xl text-brand-blue">
                {step.num}
              </div>
